...
public class RoundTest {
    ...
    @Test
    public void roundWithOneWarAndTwoPlayers(){
    ...
    @Test
    public void roundWithOneWarAndMoreThanTwoPlayers(){
        Player player1 = new Player(1);
        Card player1card1 = new Card(2, "2");
        player1.addCardToHand(player1card1);
        Card player1FaceDownCard = new Card(3, "3");
        player1.addCardToHand(player1FaceDownCard);
        Card player1card2 = new Card(4, "4");
        player1.addCardToHand(player1card2);
        Player player2 = new Player(2);
        Card player2card1 = new Card(5, "5");
        player2.addCardToHand(player2card1);
        Card player2FaceDownCard = new Card(5, "5");
        ...
        Assert.assertEquals(1, roundResults.getWinners().size());
        Assert.assertEquals(winningPlayer, roundResults.getWinners().get(0));
        Assert.assertEquals(12, roundResults.getCardsWon().size());
    }

    @Test
    public void roundWithOneWarAndMoreThanTwoPlayersWithDuplicateNonWinningCardsInTheWar(){
        Player player1 = new Player(1);
        Card player1card1 = new Card(2, "2");
        player1.addCardToHand(player1card1);
        Card player1FaceDownCard = new Card(3, "3");
        ...
        Card player2FaceDownCard = new Card(5, "5");
        player2.addCardToHand(player2FaceDownCard);
        Card player2card2 = new Card(5, "5");
        player2.addCardToHand(player2card2);
        Player warPlayer = new Player(3);
        Card warPlayerCard1 = new Card(10, "10");
        warPlayer.addCardToHand(warPlayerCard1);
    ...
    public void roundWithOneWarAndBothPlayersRunOutOfCards(){
        ...
        Assert.assertEquals(4, roundResults.getCardsWon().size());
    }
}
